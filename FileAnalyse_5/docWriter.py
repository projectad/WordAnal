...
# import shutil
# import re
# from docReader import txtReader # bu ke xin
# class docWriter:
#     # 文本内容
#     __filecontent = ''
#     # 标题内容
...
#         self.__filecontent1 = FileContent
#
...
#
#     def docDeal(self):
#         for self.__Title in self.__Title1:
#             self.__filecontent = txtReader().openFileFunc(self.__Title) # bu ke xin
...
class docWriter:
    ...
    def _docDealFunc(self):
        return self.getNumofInstance(), self.getCity(), self.getFileType(), self.getTime(), self.getJudgmentResult(), \
               self.getDefendant(), self.getRequest(), self.getPlaintiff(), self.getShiQu()
